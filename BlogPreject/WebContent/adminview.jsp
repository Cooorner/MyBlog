...
<body>
				...
				<div class="hero-unit">
					...
					<div class="panel panel-default"
						...
						<div class="hero-unit" style="padding-top:20px;color:wheat;">
							<h1>系统管理员</h1><a href="chooseArticle.do">退出</a>
						</div>
						<a href="chooseArticle.do">sql操作</a>
						<!-- 这里是博主表 -->
							...
							<table
								...
								<tbody id="tb_work_device">
									...
									<tr class="selectable">
										...
										<td class="center"><a href="toOtherBlogger.do?aimblogger=<%=blogger.getName()%>"><%=blogger.getName()%></a></td>
							...
							<table
								...
								<tbody id="tb_work_device">
									...
									<tr class="selectable">
										...
										<td class="center"><a href="readarticle.do?articleNumber=<%=article.getNumber() %>"> <%=article.getTitle()%></a></td>
										...
										<td class="center">
										 <ul class="nav navbar-nav">
										 	...
										 	<li>
												<button class="btn btn-danger" onclick="onDeleteArticle('<%=article.getNumber()%>',this)">删除</button>
											</li>
										 </ul>
										</td>
									</tr>
	...
	<script>
	function onDeleteArticle(articlenumber,itermBtn){
