		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-left">
					<li><a href="chooseArticle.do">首页</a></li>
					<li><a href="chooseArticle.do?articleType=学术">学术</a></li>
					<li><a href="chooseArticle.do?articleType=娱乐">娱乐</a></li>
					<li><a href="chooseArticle.do?articleType=体育">体育</a></li>
					<li><a href="chooseArticle.do?articleType=美图">美图</a></li>
					<li><a href="chooseArticle.do?articleType=购物">购物</a></li>
					<li><a href="chooseArticle.do?articleType=科技">科技</a></li>
				</ul>
