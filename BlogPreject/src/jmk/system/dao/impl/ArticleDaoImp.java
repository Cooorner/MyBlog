...
public class ArticleDaoImp implements ArticleDao{
	 ...
	 */
	@Override
	public void addLikeNumber(int articlenumber,int likenumber) {
		String sql = "UPDATE article set readcount=? WHERE number=?";  
        jdbcTemplateObject.update(sql,likenumber,articlenumber);  
        return ;
	}
