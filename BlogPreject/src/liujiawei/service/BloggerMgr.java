...
public class BloggerMgr {
	...
	String headPictureInitPath="pictures/head1.jpg";
	 ...
	 * 更新博主信息
	 */
	public void UpdateBlogger(Blogger bloggerNew,String oldBloggerName) {
		bloggerDaoImp.updBlogger(bloggerNew, oldBloggerName);
	}
