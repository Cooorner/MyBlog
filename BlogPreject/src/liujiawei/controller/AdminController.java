...
import liujiawei.service.SqlOperateMgr;
...
public class AdminController {
	 ...
	 * 执行sql语句
	 */
	@RequestMapping("onsql.do")
	public String sqlView(HttpServletRequest request, String sqlcontent) {
		String result = SqlOperateMgr.getInstance().excuteSql(sqlcontent);	
